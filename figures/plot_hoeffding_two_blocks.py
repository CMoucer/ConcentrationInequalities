...
if compute:
    ...
    np.savetxt(f'/Users/cmoucer/PycharmProjects/ConcentrationInequalities/data/two_blocks_bounds_variational_n_{n}_mu1_{mu1}.txt', bounds_variational, delimiter=',')
    np.savetxt(f'/Users/cmoucer/PycharmProjects/ConcentrationInequalities/data/two_blocks_bounds_exponential_n_{n}_mu1_{mu1}.txt', bounds_exponential, delimiter=',')
else:
    bounds_variational = np.genfromtxt(f'/Users/cmoucer/PycharmProjects/ConcentrationInequalities/data/two_blocks_bounds_variational_n_{n}_mu1_{mu1}.txt', delimiter=',')
    bounds_exponential = np.genfromtxt(f'/Users/cmoucer/PycharmProjects/ConcentrationInequalities/data/two_blocks_bounds_exponential_n_{n}_mu1_{mu1}.txt', delimiter=',')
...
#plt.clim(np.min(bounds_variational), np.max(bounds_variational))
